...
function Testimonials() {
     ...
     return (
          <div className=' bg-primary-grey h-82 py-28 flex flex-col items-center justify-around'>
               <div className='w-8/12 flex flex-row items-center justify-between pb-8 max-sm:w-full max-sm:justify-around'>
                    <Link to=''><img className="w-32 h-32 rounded-full hover:border-8 duration-500 max-sm:w-20 max-sm:h-20 max-sm:border-none" alt='testimonial' src="https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80"></img></Link>
                    <Link to='second' ><img className="w-32 h-32 rounded-full hover:border-8 duration-300 max-sm:w-20 max-sm:h-20 max-sm:border-none" alt='testimonial' src="https://images.unsplash.com/photo-1518577915332-c2a19f149a75?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=862&q=80"></img></Link>
                    <Link to='third'><img className="w-32 h-32 rounded-full hover:border-8 duration-300 max-sm:w-20 max-sm:h-20 max-sm:border-none" alt='testimonial' src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80"></img></Link>
               </div>
               <div>
                    <h1 className="text-3xl font-bold text-center max-sm:text-3xl">Testimonials</h1>
               </div>
